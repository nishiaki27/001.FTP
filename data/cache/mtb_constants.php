<?php
/** フロント表示関連 */
define('SAMPLE_ADDRESS1', "市区町村名 (例：品川区西五反田)");
/** フロント表示関連 */
define('SAMPLE_ADDRESS2', "番地・ビル名 (例：2-9-7-4階)");
/** ユーザファイル保存先 */
...
/** 拡大画像横 */
define('LARGE_IMAGE_WIDTH', 600);
/** 拡大画像縦 */
define('LARGE_IMAGE_HEIGHT', 600);
/** 一覧画像横 */
define('SMALL_IMAGE_WIDTH', 160);
/** 一覧画像縦 */
...
/** 通常サブ画像横 */
define('NORMAL_SUBIMAGE_WIDTH', 300);
/** 通常サブ画像縦 */
define('NORMAL_SUBIMAGE_HEIGHT', 300);
/** 拡大サブ画像横 */
define('LARGE_SUBIMAGE_WIDTH', 600);
/** 拡大サブ画像縦 */
define('LARGE_SUBIMAGE_HEIGHT', 600);
/** 一覧表示画像横 */
define('DISP_IMAGE_WIDTH', 160);
/** 一覧表示画像縦 */
define('DISP_IMAGE_HEIGHT', 160);
/** その他の画像1 */
define('OTHER_IMAGE1_WIDTH', 600);
/** その他の画像1 */
define('OTHER_IMAGE1_HEIGHT', 600);
...
/** CSVサイズ制限(KB) */
define('CSV_SIZE', 20000);
/** CSVアップロード1行あたりの最大文字数 */
define('CSV_LINE_MAX', 100000);
...
/** 価格名称 */
define('NORMAL_PRICE_TITLE', "定価");
/** 価格名称 */
define('SALE_PRICE_TITLE', "限定特別価格");
/** ログファイル */
...
/** 長中文の文字数 (問い合わせなど) */
define('MLTEXT_LEN', 9999);
/** 長文の文字数 */
define('LTEXT_LEN', 9999);
/** 超長文の文字数 (メルマガなど) */
...
/** 商品詳細(HTML出力) */
define('P_DETAIL_URLPATH', ROOT_URLPATH . "products/");
/** マイページお届け先URL */
...
/** テンプレート名 */
define('TEMPLATE_NAME', "tokyo-aircon");
/** モバイルテンプレート名 */
