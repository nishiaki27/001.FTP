...
忘れた時のヒント<span class="attention2">必須</span></th>
        ...
        <tr>
            <th><span class="attention2">必須</span>弊社からの情報を<br />
受け取る</th>
            <td>
                ...
                <span style="<!--{$arrErr.mailmaga_flg|sfGetErrorColor}-->">
                    <input type="radio" name="mailmaga_flg" value="1" id="html" <!--{if $arrForm.mailmaga_flg <> 2}--> checked="checked" <!--{/if}--> /><label for="html">受け取る</label><br />
                    <input type="radio" name="mailmaga_flg" value="2" id="text" <!--{if $arrForm.mailmaga_flg eq 2}--> checked="checked" <!--{/if}--> /><label for="text">受け取らない</label><br />
