...
class SC_Helper_Customer {
     ...
     * @param boolean $isAdmin true:管理者画面 false:顧客向け
     * @access public
     * @return void
     */
    ...
    function sfCustomerCommonParam (&$objFormParam) {
        ...
        $objFormParam->addParam("お名前", 'name02', STEXT_LEN, 'aKV', array("EXIST_CHECK", "NO_SPTAB", "SPTAB_CHECK" , "MAX_LENGTH_CHECK"));
        $objFormParam->addParam("会社名(フリガナ)", 'kana01', STEXT_LEN, 'CKV', array("NO_SPTAB", "SPTAB_CHECK" ,"MAX_LENGTH_CHECK", "KANA_CHECK"));
        $objFormParam->addParam("お名前(フリガナ)", 'kana02', STEXT_LEN, 'CKV', array("EXIST_CHECK", "NO_SPTAB", "SPTAB_CHECK" ,"MAX_LENGTH_CHECK", "KANA_CHECK"));
