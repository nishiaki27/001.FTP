 ...
 */
class LC_Page_Admin_Order_KikanMail extends LC_Page_Admin_Order_Ex {
    ...
    function init() {
        parent::init();
        $this->tpl_mainpage = 'order/kikanmail.tpl';
    ...
    function action() {
        ...
        $this->arrKikanData = $objPurchase->getKikanData($order_id, false);
    }
    ...
    function lfInitParam(&$objFormParam) {
        ...
        $objFormParam->addParam("顧客名", "order_name02", STEXT_LEN, 'KVa', array("EXIST_CHECK", "SPTAB_CHECK", "MAX_LENGTH_CHECK"));
        $objFormParam->addParam("会社名カナ", "order_kana01", STEXT_LEN, 'KVCa', array("SPTAB_CHECK", "MAX_LENGTH_CHECK"));
        $objFormParam->addParam("顧客名カナ", "order_kana02", STEXT_LEN, 'KVCa', array("EXIST_CHECK", "SPTAB_CHECK", "MAX_LENGTH_CHECK"));
