...
class LC_Page_Admin_Order_Pdf extends LC_Page_Admin_Ex {
    ...
    function createFromValues($order_id,$pdf_order_id){
        ...
        if($_GET['pay_date']){
        	...
        	$arrForm['pay_year']  = date('Y');
        	$arrForm['pay_month'] = date('m');
        	$arrForm['pay_day']   = date('d');
   	    }
    ...
    function lfInitParam(&$objFormParam) {
        ...
        $objFormParam->addParam("入金日", 'pay_year', INT_LEN, 'n', array("EXIST_CHECK", "MAX_LENGTH_CHECK", "NUM_CHECK"));
        $objFormParam->addParam("入金日", 'pay_month', INT_LEN, 'n', array("EXIST_CHECK", "MAX_LENGTH_CHECK", "NUM_CHECK"));
        $objFormParam->addParam("入金日", 'pay_day', INT_LEN, 'n', array("EXIST_CHECK", "MAX_LENGTH_CHECK", "NUM_CHECK"));
