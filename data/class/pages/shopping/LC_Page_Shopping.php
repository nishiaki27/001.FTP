 ...
 * @version $Id: LC_Page_Shopping.php 21402 2012-01-17 07:15:39Z Seasoft $
 */
class LC_Page_Shopping extends LC_Page_Ex {
    ...
    function lfInitParam(&$objFormParam) {
        ...
        $objFormParam->addParam("会社名", "order_name01", STEXT_LEN, 'KVa', array("SPTAB_CHECK", "MAX_LENGTH_CHECK"));
        $objFormParam->addParam("お名前", "order_name02", STEXT_LEN, 'KVa', array("EXIST_CHECK", "SPTAB_CHECK", "MAX_LENGTH_CHECK"));
        $objFormParam->addParam("会社名(フリガナ)", "order_kana01", STEXT_LEN, 'KVCa', array("KANA_CHECK", "SPTAB_CHECK", "MAX_LENGTH_CHECK"));
        $objFormParam->addParam("お名前(フリガナ)", "order_kana02", STEXT_LEN, 'KVCa', array("EXIST_CHECK", "KANA_CHECK", "SPTAB_CHECK", "MAX_LENGTH_CHECK"));
        ...
        $objFormParam->addParam("DM発送", "note", STEXT_LEN, 'n', array("MAX_LENGTH_CHECK"));
    }
    ...
    function lfCheckError(&$objFormParam) {
        ...
        if (isset($arrParams['deliv_check']) && $arrParams['deliv_check'] == "1") {
            $objErr->doFunc(array("会社名", "shipping_name01"), array());
            $objErr->doFunc(array("お名前", "shipping_name02"), array("EXIST_CHECK"));
            $objErr->doFunc(array("会社名(フリガナ)", "shipping_kana01"), array());
            $objErr->doFunc(array("お名前(フリガナ)", "shipping_kana02"), array("EXIST_CHECK"));
