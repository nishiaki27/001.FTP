...
<!--{/if}-->
<input type="text" name="<!--{$key}-->" value="" maxlength="<!--{$arrForm[$key].length}-->" size="<!--{$arrForm[$key].length}-->" istyle="<!--{$arrForm[$key].length}-->">
<br>
...
<!--{/if}-->
名<input type="text" name="<!--{$key_name01}-->" value="" size="10" istyle="3">
姓<input type="text" name="<!--{$key_name02}-->" value="" size="10" istyle="3"><br>
...
<font color="red"><!--{$arrErr[$key]}--></font>
<!--{/if}-->
<input type="text" name="<!--{$key}-->" value="" maxlength="<!--{$arrForm[$key].length}-->" size="<!--{$arrForm[$key].length}-->"><br>
