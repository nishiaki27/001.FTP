 ...
 * @version $Id: LC_Page_TwoClick_2.11.4.php 3836 2012-02-16 01:09:23Z takashi $
 */
class LC_Page_TwoClick extends LC_Page_Ex {
    ...
    function init() {
        ...
        if (SC_Display_Ex::detectDevice() === DEVICE_TYPE_SMARTPHONE) {
            $this->tpl_mainpage = MODULE_REALDIR . 'mdl_pg_mulpay/copy/2click/data/Smarty/templates/sphone/twoClick/index_2.11.4.tpl';
        }
    }
