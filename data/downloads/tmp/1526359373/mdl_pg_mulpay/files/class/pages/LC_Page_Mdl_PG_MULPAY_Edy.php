...
/**
 * Mobile Edy決済情報入力画面 のページクラス.
 *
 * @package Page
 */
class LC_Page_Mdl_PG_MULPAY_Edy extends LC_Page_Mdl_PG_MULPAY {
    /**
     * Page を初期化する.
     *
     * @return void
    ...
    function setTemplateVars() {
        ...
        $this->tpl_payment_method = 'Mobile Edy';
    ...
    function getSerializeMessage($arrExecRet) {
        $message['title'] = $this->lfSetConvMSG(EDY_MEG_TITLE, true);
        $message['payment_term'] = $this->lfSetConvMSG("お支払期限", LC_Mdl_PG_MULPAY_Utils::convertDate($this->arrExecRet['PaymentTerm'], "Y年m月d日 H時i分") . "\n\n");
        $message['message'] = $this->lfSetConvMSG(EDY_MEG_SUB_TITLE, EDY_MEG_BODY);
        return $message;
    }
