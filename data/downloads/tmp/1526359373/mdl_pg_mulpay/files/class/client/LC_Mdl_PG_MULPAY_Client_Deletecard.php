 ...
 *
 */
class LC_Mdl_PG_MULPAY_Client_Deletecard extends LC_Mdl_PG_MULPAY_Client {
    /**
     * DeleteCardリクエストを送信する
     *
     */
    function request($cardSeq) {
        $objCustomer = new SC_Customer;
        $objPG =& LC_Mdl_PG_MULPAY::getInstance();
        $serverUrl = $objPG->getUserSettings('server_url') . 'DeleteCard.idPass';
