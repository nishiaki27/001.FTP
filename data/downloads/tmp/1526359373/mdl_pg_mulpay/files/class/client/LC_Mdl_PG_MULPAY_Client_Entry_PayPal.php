...
/**
 * PayPal決済 EntryTranを実行する
 *
 */
class LC_Mdl_PG_MULPAY_Client_Entry_PayPal extends LC_Mdl_PG_MULPAY_Client_Entry {
    /**
     * EntryTran名を取得する
     *
