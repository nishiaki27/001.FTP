 ...
 * @version $Id: LC_Page_TwoClick_Deliv_2.11.5.php 3979 2012-03-18 18:31:51Z takashi $
 */
class LC_Page_TwoClick_Deliv extends LC_Page_Ex {
    ...
    function init() {
        ...
        $this->tpl_mainpage = 'twoClick/deliv.tpl';
    ...
    function action() {
        ...
        // 削除
        case 'delete':
            $this->doDelete($arrForm['other_deliv_id'], $objCustomer);
            break;
     ...
     * @return void
     */
    function doDelete($other_deliv_id, $objCustomer) {
        $objQuery =& SC_Query_Ex::getSingletonInstance();
        $where = "other_deliv_id = ? AND customer_id = ?";
        $objQuery->delete("dtb_other_deliv", $where, array($other_deliv_id, $objCustomer->getValue('customer_id')));
    }
