 ...
 *}-->
<!--{*
$Id: index_2.11.2.tpl 2929 2011-08-15 06:32:21Z takashi $
 *}-->
<!--▼CONTENTS-->
<script>
  function ajaxLogin() {
      ...
      if (checkLogin == false) {
          ...
          $.ajax({
              type: "POST",
              url: "<!--{$smarty.const.ROOT_URLPATH}-->twoClick/index.php",
              data: postData,
              cache: false,
              dataType: "json",
              ...
              success: function(result){
                  if (result.success) {
                      location.href = '<!--{$smarty.const.ROOT_URLPATH}-->twoClick/' + result.success;
                  } else {
...
<!--<!--{$smarty.const.HTTP_URL}-->twoClick/index.php-->
