...
<div id="order" class="contents-main">
    <h2>抽出条件</h2>
        <div class="btn">
        <!--{foreach key=key item=item from=$arrDocomoSTATUS}-->
            <a
                class="btn-normal"
    ...
    <!--{if $tpl_linemax > 0}-->
        <div class="btn">
            <select name="change_status">
                ...
                <!--{foreach key=key item=item from=$arrDocomoSTATUS_CHANGE}-->
    ...
    <p class="remark">
        ...
        <table class="list center">
            ...
            <tr style="background:<!--{$arrORDERSTATUS_COLOR[$status]}-->;">
                ...
                <!--{assign var=docomo_status value="`$arrStatus[cnt].memo04`"}-->
                <td><!--{$arrDocomoSTATUS[$docomo_status]|h}--></td>
