...
登録済みのカード情報を呼び出して、<br/>削除してください。</p>
    ...
    <input type="hidden" name="deleteCardSeq" value="" />
      ...
      <div class="btn_area">
        <ul>
          ...
          <li>
            ...
            <!--{else}-->
            <a href="#" onmouseover="chgImg('<!--{$TPL_URLPATH}-->img/button/btn_order_comp_on.png','next')" onmouseout="chgImg('<!--{$TPL_URLPATH}-->img/button/btn_order_comp.png','next')" onclick="fnCheckSubmit('register', '', '');return false;">
      ...
      <div class="btn_area">
        <ul>
          <li>
            <a href="#" onmouseover="chgImg('<!--{$TPL_URLPATH}-->img/button/btn_inq_back_on.png','back04')" onmouseout="chgImg('<!--{$TPL_URLPATH}-->img/button/btn_inq_back.jpg','back04')" onclick="fnModeSubmit('return','',''); return false;">
