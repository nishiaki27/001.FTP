 ...
 * @version $Id: LC_Page_TwoClick_2.11.5.php 3911 2012-02-29 17:03:40Z takashi $
 */
class LC_Page_TwoClick extends LC_Page_Ex {
    ...
    function init() {
        ...
        if (SC_Display_Ex::detectDevice() === DEVICE_TYPE_SMARTPHONE) {
            $this->tpl_mainpage = MODULE_REALDIR . 'mdl_pg_mulpay/copy/2click/data/Smarty/templates/sphone/twoClick/index_' . ECCUBE_VERSION . '.tpl';
        }
    }
