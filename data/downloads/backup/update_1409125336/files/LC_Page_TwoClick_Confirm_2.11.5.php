 ...
 * @version $Id: LC_Page_TwoClick_Confirm_2.11.5.php 4224 2012-06-01 06:17:26Z takashi $
 */
class LC_Page_TwoClick_Confirm extends LC_Page_Ex {
                                 ...
                                 &$objPurchase, &$objCartSess, &$objQuery, $uniqid)
    {
        ...
        if ($deliv == null || !is_array($deliv)) {
            // 配送業者は削除され既に存在しない。
            LC_Mdl_PG_MULPAY::printLogU("deliv not found: " . print_r($deliv,true));
            return false;
        }
