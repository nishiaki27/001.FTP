...
<div id="undercolumn">
    <div id="undercolumn_shopping">
        ...
        <h2 class="title1"><!--{$tpl_title|h}--></h2>
	...
	<!--{/if}-->
        ...
        <div class="btn_area">
            <ul>
                <li>
                    <a href="./payment.php" onmouseover="chgImg('<!--{$TPL_URLPATH}-->img/button/btn_inq_back.png', 'back04-top')" onmouseout="chgImg('<!--{$TPL_URLPATH}-->img/button/btn_inq_back.png', 'back04-top')"><img src="<!--{$TPL_URLPATH}-->img/button/btn_inq_back.png" alt="戻る" border="0" name="back04-top" id="back04-top" /></a>
                </li>
                    <!--{if $use_module}-->
                <li>
                    ...
                    <!--{else}-->
                <li>
                    <input type="image" onclick="return fnCheckSubmit();" onmouseover="chgImgImageSubmit('<!--{$TPL_URLPATH}-->img/button/btn_order_comp.png',this)" onmouseout="chgImgImageSubmit('<!--{$TPL_URLPATH}-->img/button/btn_order_comp.png',this)" src="<!--{$TPL_URLPATH}-->img/button/btn_order_comp.png" alt="ご注文完了ページへ" name="next-top" id="next-top" />
                </li>
                <!--{/if}-->
            </ul>
        </div>
	...
	<!--{/if}-->
        ...
        <div class="btn_area">
            <ul>
                <li>
                    <a href="./payment.php" onmouseover="chgImg('<!--{$TPL_URLPATH}-->img/button/btn_inq_back.png','back<!--{$key}-->');" onmouseout="chgImg('<!--{$TPL_URLPATH}-->img/button/btn_inq_back.png','back<!--{$key}-->');"><img src="<!--{$TPL_URLPATH}-->img/button/btn_inq_back.png" alt="戻る" name="back<!--{$key}-->" /></a>
                </li>
                <!--{if $use_module}-->
                <li>
		...
		<!--{/if}-->
                <!--{else}-->
                <li>
                    <input type="image" onclick="return fnCheckSubmit();" onmouseover="chgImgImageSubmit('<!--{$TPL_URLPATH}-->img/button/btn_order_comp.png',this)" onmouseout="chgImgImageSubmit('<!--{$TPL_URLPATH}-->img/button/btn_order_comp.png',this)" src="<!--{$TPL_URLPATH}-->img/button/btn_order_comp.png" alt="ご注文完了ページへ"  name="next" id="next" />
                </li>
                <!--{/if}-->
        </ul>
