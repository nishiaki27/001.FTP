...
<section id="undercolumn">
    ...
    <form name="form1" id="form1" method="post" action="./load_payment_module.php" autocomplete="off">
        ...
        <div class="btn_area">
            <p>
                プリペイドカードおよびウォレットにチャージされている電子マネーからお支払いいただけます。<br />
        ...
        <table border='1' class="emony_discription">
            <tr>
                <th>WebMoney</th>
                <td>プリペイドカードご利用の場合はカード記載の番号、ウォレットご利用の場合はウォレットID/パスワードに続いてセキュアパスワードを入力することによりお支払が可能です。</td>
            </tr>
        </table>
