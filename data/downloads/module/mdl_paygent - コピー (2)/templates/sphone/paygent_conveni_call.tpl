    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          ...
          <p class="zipimg">
	     <a href="<!--{$smarty.const.ROOT_URLPATH}-->input_zip.php" onclick="fnCallAddress('<!--{$smarty.const.INPUT_ZIP_URLPATH}-->', 'customer_zip01', 'customer_zip02', 'customer_pref', 'customer_addr01'); return false;" target="_blank" class="oubtn">住所自動入力</a><br />
...
　<div class="tblareabtn">
  	<p><input type="submit" value="次へ" class="spbtn spbtn-shopping" width="130" height="30" alt="次へ" name="next" id="next" /></p>
        <p><input type="submit" onclick="fnModeSubmit('return', '', ''); return false;" value="戻る" class="spbtn spbtn-medeum" alt="戻る" name="return" id="return" /></p>
  </div>
  </form>
