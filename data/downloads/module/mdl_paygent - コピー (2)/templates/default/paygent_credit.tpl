...
<div id="undercolumn_shopping">
  ...
  <div class="btn_area">
    <ul>
      ...
      <li>
        <!--{if $token_pay == 1}-->
          <input type="image" onclick="startCreateToken();return false" onmouseover="chgImg('<!--{$TPL_URLPATH}-->img/button/btn_next_on.jpg',this)" onmouseout="chgImg('<!--{$TPL_URLPATH}-->img/button/btn_next.jpg',this)" src="<!--{$TPL_URLPATH}-->img/button/btn_next.jpg" alt="次へ" border="0" name="next" id="next" />
        <!--{else}-->
