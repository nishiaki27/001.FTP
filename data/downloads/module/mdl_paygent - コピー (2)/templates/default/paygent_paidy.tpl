...
<!-- <form name="form1" id="form1" method="post" action="./load_payment_module.php" autocomplete="off"> -->
  ...
  <div class="btn_area">
    <ul>
      <li>
        <input type="image" onclick="checkPaidyPay('return');return false" class="hover_change_image" src="<!--{$TPL_URLPATH}-->img/button/btn_back.jpg" alt="戻る" name="back03" id="back03" />
      </li>
      <!--{if $tpl_shipping_error == ""}-->
      <li>
