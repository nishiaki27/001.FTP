        ...
        <form name="form<!--{$key}-->" id="form<!--{$key}-->" method="post" action="<!--{$smarty.const.CART_URLPATH|h}-->">
            ...
            <div class="formBox">
                ...
                <!--{foreach from=$cartItems[$key] item=item}-->
                    ...
                    <div class="cartitemBox">
                     ...
                     <div>
                      ...
                      <!--{/if}-->
                      <span class="mini">価格:</span><!--{$item.price|sfCalcIncTax:$arrInfo.tax:$arrInfo.tax_rule|number_format}-->円
                      </p>
                    <p class="btn_delete">
              ...
              <!--{if strlen($tpl_error) == 0}-->
                ...
                <!--{if $isEnable2click}-->
		<br/>
                <input type="submit" value="2クリック購入手続きへ" class="btn data-role-none" name="2click_confirm" onclick="fnFormModeSubmit('form<!--{$key}-->', 'mdl_pg_mulpay_2click','',''); return false;" />
                <!--{/if}-->
                </div>
              <!--{/if}-->
            </div><!--▲formBox -->
