...
<ul id="quantity_level">
		    ...
		    <!--{if $isEnable2click}-->
                        <p>
                        <input type="button" value="2クリック購入手続きへ" class="spbtn spbtn-shopping" width="130" height="30" alt="購入手続きへ" name="2click_confirm" onclick="fnFormModeSubmit('form<!--{$key}-->', 'mdl_pg_mulpay_2click','',''); return false" />
                        </p>
		    <!--{/if}-->
                    <!--{/if}-->
                    <!--{if $tpl_prev_url != ""}-->
