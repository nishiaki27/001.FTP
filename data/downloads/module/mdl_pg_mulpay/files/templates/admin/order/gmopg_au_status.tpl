...
<div id="order" class="contents-main">
    <h2>抽出条件</h2>
        <div class="btn">
        <!--{foreach key=key item=item from=$arrAUSTATUS}-->
            <a
                class="btn-normal"
    ...
    <!--{if $tpl_linemax > 0}-->
        <div class="btn">
            <select name="change_status">
                ...
                <!--{foreach key=key item=item from=$arrAUSTATUS_CHANGE}-->
...
*}-->
    ...
    <p class="remark">
        ...
        <table class="list center">
            ...
            <!--{assign var=au_paymethod value="`$arrStatus[cnt].memo05`"}-->
            <tr style="background:<!--{$arrORDERSTATUS_COLOR[$status]}-->;">
                <td><!--{if $au_paymethod != '03'}--><input type="checkbox" name="move[]" value="<!--{$arrStatus[cnt].order_id}-->" ><!--{/if}--></td>
                ...
                <!--{assign var=au_status value="`$arrStatus[cnt].memo04`"}-->
                <td><!--{$arrAUSTATUS[$au_status]|h}--></td>
                <td><!--{$arrAUPAYMETHOD[$au_paymethod]|h}--></td>
