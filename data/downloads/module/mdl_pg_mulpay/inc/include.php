...
define('MDL_PG_MULPAY_VERSION', '2.3.17');
...
define('CONVENI_LOSON_NEW', '10001');
define('CONVENI_FAMILYMART', '00002');
define('CONVENI_FAMILYMART_NEW', '10002');
define('CONVENI_SUNKUS', '00003');
define('CONVENI_SUNKUS_NEW', '10003');
define('CONVENI_CIRCLEK', '00004');
define('CONVENI_CIRCLEK_NEW', '10004');
define('CONVENI_MINISTOP', '00005');
define('CONVENI_MINISTOP_NEW', '10005');
...
$GLOBALS['arrMobileMailDomain'] = array(
    ...
    'pdx.ne.jp' => "pdx.ne.jp",
    'willcom.com' => "willcom.com",
    'emnet.ne.jp' => "emnet.ne.jp",
);
...
define('MDL_PG_MULPAY_DOCOMO_PAY_TYPE', 9);
$arrPayType = array(
    ...
    MDL_PG_MULPAY_DOCOMO_PAY_TYPE => 'ドコモケータイ払い',
);
...
\n
＜＜お支払い方法＞＞
1．サークルＫサンクス Ｋステーションのメニュー画面にて「各種支払い」を選択してください。
2．「6ケタの番号をお持ちの方」を選択してください。
3．受付番号(6桁)を入力し、「次に進む」を選択してください。
4．確認番号(10桁)を入力し、「次に進む」を選択してください。
5．ご注意事項を確認のうえ、「次に進む」を選択してください。
6．お支払い内容を確認のうえ、「次に進む」を選択してください。
7．印刷された受付票をレジに渡し、30分以内に現金でお支払いください。
8．お支払い後、領収書を必ずお受け取りください。",
    CONVENI_CIRCLEK       => "
●サークルＫサンクス全店でお支払いいただけます。
●「オンライン決済」と店員にお伝えください。
●お支払いの際、オンライン決済番号が必要です。
