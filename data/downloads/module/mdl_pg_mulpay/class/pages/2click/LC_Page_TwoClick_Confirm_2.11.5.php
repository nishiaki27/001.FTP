 ...
 * @version $Id: LC_Page_TwoClick_Confirm_2.11.5.php 3979 2012-03-18 18:31:51Z takashi $
 */
class LC_Page_TwoClick_Confirm extends LC_Page_Ex {
    ...
    function action() {
        ...
        */
        ...
        LC_Mdl_PG_MULPAY::printDLog('mode=' . $this->getMode());
        ...
        LC_Mdl_PG_MULPAY::printDLog($this->arrShipping);
        $this->arrCartItems = $objCartSess->getCartList($this->cartKey);
        LC_Mdl_PG_MULPAY::printDLog($this->arrCartItems);
        // 合計金額
    ...
    function registerDeliv($deliv_check, $uniqid, &$objPurchase, &$objCustomer) {
        LC_Mdl_PG_MULPAY::printDLog($deliv_check);
        $arrValues = array();
        // 会員登録住所がチェックされている場合
        if ($deliv_check == '-1') {
    ...
    function show2ClickPurchase(&$arrData) {
        ...
        LC_Mdl_PG_MULPAY::printDLog($arrData);
    ...
    function setup2ClickPurchase(&$objPurchase, &$objCustomer, &$objCartSess, &$objQuery, $uniqid, $product_type_id) {
        ...
        LC_Mdl_PG_MULPAY::printDLog($arrOrderTemp);
        ...
        if (!$lastOrder) {
            ...
            $arr2Click['update_date'] = 'CURRENT_TIMESTAMP';
        ...
        $arr2Click['update_date'] = 'CURRENT_TIMESTAMP';
        LC_Mdl_PG_MULPAY::printDLog('saveOrderTemp=' . print_r($arr2Click,true));
        $objPurchase->saveOrderTemp($uniqid, $arr2Click, $objCustomer);
    }
    ...
    function saveShippings(&$arrForm, $arrDelivTime) {
        LC_Mdl_PG_MULPAY::printDLog($arrForm);
                                 ...
                                 &$objPurchase, &$objCartSess, &$objQuery, $uniqid)
    {
        ...
        case MDL_PG_MULPAY_PAYMENT_TOKEN:
        ...
        case MDL_PG_MULPAY_PAYMENT_DOCOMO:
