...
class LC_Page_Mdl_PG_MULPAY_Credit extends LC_Page_Mdl_PG_MULPAY {
    ...
    function initParamAdd(&$objForm) {
        ...
        $objForm->addParam("名", "card_name01", 25, "KVa", array("EXIST_CHECK", "MAX_LENGTH_CHECK", "ALPHA_CHECK"));
        $objForm->addParam("姓", "card_name02", 24, "KVa", array("EXIST_CHECK", "MAX_LENGTH_CHECK", "ALPHA_CHECK"));
