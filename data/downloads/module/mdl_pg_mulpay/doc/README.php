...
20120607
  - Version 2.2.4
  - 注文確認画面から決済情報入力画面へブラウザのバックボタンで移動した
    場合、『不正な遷移』となるように修正。修正前は、そのまま決済完了でき
    るにもかかわらず、EC-CUBEの受注情報が論理削除され参照できない状態になる。

20120601
  - Version 2.2.3
  - 2クリック決済にて、配送業者が削除されていた場合、業者が空のまま
    決済完了できてしまう問題を修正

20120528
  - 受注管理＞受注登録画面にて、複数の配送先を指定するとシステムエラー
    が発生する問題を修正 (templates/admin/order/edit.tpl)

20120424
  - Version 2.2.2
  - 2クリック決済にて、お届け先[変更する] > [複数のお届け先に送る] >
    [新しいお届け先を追加する] > [登録する] で【不正なアクセスです】
    となる問題を修正
...
===================================================
  ...
  ■ 決済状況変更機能(クレジット,PayPal,iD,auかんたん決済)に必要なファイル
...
$Date: 2012-06-15 15:02:51 +0900 (Fri, 15 Jun 2012) $
