...
<div id="order" class="contents-main">
    <h2>抽出条件</h2>
        <div class="btn">
        <!--{foreach key=key item=item from=$arrNETIDSTATUS}-->
            <a
                class="btn-normal"
    ...
    <!--{if $tpl_linemax > 0}-->
        <div class="btn">
            <select name="change_status">
                ...
                <!--{foreach key=key item=item from=$arrNETIDSTATUS_CHANGE}-->
...
*}-->
            ...
            <tr style="background:<!--{$arrORDERSTATUS_COLOR[$status]}-->;">
                ...
                <!--{assign var=netid_status value="`$arrStatus[cnt].memo04`"}-->
                <td><!--{$arrNETIDSTATUS[$netid_status]|h}--></td>
