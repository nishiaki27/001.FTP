 ...
 *}-->
 ...
 <link rel="stylesheet" href="/user_data/packages/tokyo-aircon/css/sp.css" type="text/css" media="all" />
...
<p class="pt10 mb20" style="text-align: center;"><img src="/user_data/packages/tokyo-aircon/img/picture/img_flow_23.jpg" alt="購入手続きの流れ"></p>

<h2 class="title1"><span>お支払い方法：<!--{$tpl_payment_method}--></span></h2>
...
登録済みのカード情報を呼び出して、<br/>削除してください。</p>
    ...
    <table summary="決済情報の入力">
      <tr>
        ...
        <td>
		 ...
		 id="<!--{$key}-->"
                 ...
                 class="box120"
                 style="ime-mode: disabled; <!--{$arrErr[$key]|sfGetErrorColor}--> width:90%;"/>
          <p class="mini">半角入力(例：1234567890123456 ※ハイフンなし)</p>
        </td>
      </tr>
      <tr>
      ...
      <div class="btn_area">
        <ul>
          <li>
            <a href="#" onmouseover="chgImg('<!--{$TPL_URLPATH}-->img/button/btn_inq_back_on.png','back03')" onmouseout="chgImg('<!--{$TPL_URLPATH}-->img/button/btn_inq_back.png','back03')" onclick="fnModeSubmit('return','',''); return false;">
              <img src="<!--{$TPL_URLPATH}-->img/button/btn_inq_back.png" alt="戻る" border="0" name="back03" id="back03" /></a>
          </li>
          <li>
            <!--{if $is2clickFlow}-->
            ...
            <!--{else}-->
            <a href="#" onmouseover="chgImg('<!--{$TPL_URLPATH}-->img/button/btn_order_comp_on.png','next')" onmouseout="chgImg('<!--{$TPL_URLPATH}-->img/button/btn_order_comp.png','next')" onclick="doPurchase(); return false;">
              <img src="<!--{$TPL_URLPATH}-->img/button/btn_order_comp.png" alt="ご注文完了ページへ" name="next" id="next" /></a>
            <!--{/if}-->
          </li>
        </ul>
      </div>
      ...
      <div class="btn_area">
        <ul>
          <li>
            <a href="#" onmouseover="chgImg('<!--{$TPL_URLPATH}-->img/button/btn_inq_back_on.png','back04')" onmouseout="chgImg('<!--{$TPL_URLPATH}-->img/button/btn_inq_back.png','back04')" onclick="fnModeSubmit('return','',''); return false;">
              <img src="<!--{$TPL_URLPATH}-->img/button/btn_inq_back.png" alt="戻る" border="0" name="back04" id="back04" /></a>
          </li>
          <li>
            <!--{if $is2clickFlow}-->
            ...
            <!--{else}-->
            <a href="#" onmouseover="chgImg('<!--{$TPL_URLPATH}-->img/button/btn_order_comp_on.png','next02')" onmouseout="chgImg('<!--{$TPL_URLPATH}-->img/button/btn_order_comp.png','next02')" onclick="fnCheckSubmit('register', 'usecard', '1'); return false;">
              <img src="<!--{$TPL_URLPATH}-->img/button/btn_order_comp.png" alt="ご注文完了ページへ" name="next02" id="next02" /></a>
            <!--{/if}-->
          </li>
        </ul>
      </div>
